...
class BkdDosenController extends Controller
{
    ...
    public function actionAjaxUpdateStatus()
    {
        ...
        if(!empty($_POST['dataPost']) && Yii::$app->request->isPost){
            ...
            $model->status_bkd = $dataPost['status_bkd'];
    ...
    public function actionAjaxListPengabdian()
    {
        $results = [];
        ...
        if(!empty($_POST['dataPost']) && Yii::$app->request->isPost){
            ...
            foreach($rows as $item)
            {
                $results[] = [
                    ...
                    'status_bkd' => (!empty($list_status[$item['status_bkd']]) ? $list_status[$item['status_bkd']] : null),
                    'instansi' => '',
                    'jumlah_kegiatan' => 1,
                    'tanggal_mulai' => '',
                    'tanggal_selesai' => '',
